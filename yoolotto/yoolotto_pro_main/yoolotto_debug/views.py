...
def data_entry_images(req):
  ...
  ca_tickets = LotteryTicketAvailable.objects.exclude(ticket__division_id=1).exclude(image_first="").order_by('-id').values_list('play_id','image_first','defected').distinct()[0:250]
