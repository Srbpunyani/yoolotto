...
class YooGames(View):
    ...
    def get(self,request):
        return {"games":[{"game_vendor":"cataboom","name":"slot","game_image":"/static/admin/img/slot.jpg"},{"game_vendor":"cataboom","name":"scratch","game_image":"/static/admin/img/scratch.jpg"}]}
...
class SCACoins(View):
    ...
    def post(self,request):
		...
		yoo_limit_record = YooGamesLimit(user=client_login_record)
                yoo_limit_record.save()
                return {"result":1}
