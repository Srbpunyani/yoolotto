...
class CoinTicketManager(object):
    ...
    def add_coins(self):
        print "in add coins in coins"
        print "email is",self._user_email
        if self._user_email:
        ...
        print "coins_recorddd",coins_record
        print "coins record before adding",coins_record.coins    
        coins_record.coins = F('coins') + 10
        print "coins_record aftr adding",coins_record.coins
        coins_record.save()
