	...
	RetailerNo = ''
        try:
      	...
      	if state == 'TX' and old_version == False:
            ocr_lib = cdll.LoadLibrary("/home/ubuntu/yo/yoolotto/yoolotto/OCR-OCR_server/YoolottoOCR/libOCR.so") # pass the path of .so file
            ...
            lib_prt_path ="/home/ubuntu/yo/yoolotto/yoolotto/OCR-OCR_server"
