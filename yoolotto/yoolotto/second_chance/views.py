...
from yoolotto.second_chance.models import FiberCoins, DwollaUserInfo, DwollaTransactionInfo,Events,EventInfo
    ...
    def post(self,request):
        ...
        try:
            ...
            if data['referred_user']:
                ...
                referred_coins = EmailCoins.objects.get(email = data['referred_user'])
