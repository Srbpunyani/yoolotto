...
class LotteryTicket(models.Model):
    ...
    def representation(self,email,
        ...
        *args, **kwargs):
        print "in rep22222222222222222222222222222222"
        return representation(self,email)(*args, **kwargs)

    def representation_old(self,
        representation_old=representations.TicketRepresentationShortList_old,
        *args, **kwargs):
        print "in rep oldddddddddddddddddddddddddddddddd"
