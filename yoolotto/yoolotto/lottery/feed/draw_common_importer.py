...
#                         print "<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<"
				    ...
				    parent_game = LotteryGame.objects.get_or_create(
						    name=component_meta["game_name"],
						    code=component_meta["game_format"]
						    )
...
#                                     print "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"    
				        ...
				        try:
					    draw= \
					    LotteryDraw.objects.get(component=component,date=last_draw_date,division_id=division.id)
					    created = False
                                    ...
                                    if component_meta["game_name"] == "Powerball" and len(ast.literal_eval(draw.result)) == 7 and remote_id=="TX":
                                        ...
                                        powerplay_component, created = LotteryGameComponent.objects.get_or_create(
					    ...
					    powerplay_draw = LotteryDraw.objects.get_or_create(component=powerplay_component,date=last_draw_date,division_id=division.id,result=powerplay)
	                                    powerplay_created = False
				    ...
				    try:
				        ...
				        draw = LotteryDraw.objects.get(component=component,date=next_draw_date,division_id=division.id)
	                                created = False
